...
const useDatabase = () => {
   ...
   */
  const createDocument = useCallback(async (collectionId, data) => {
    try {
   ...
   */
  const updateDocument = useCallback(async (collectionId, documentId, data) => {
    try {
   ...
   */
  const deleteDocument = useCallback(async (collectionId, documentId) => {
    try {
