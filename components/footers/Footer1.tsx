...
export default function Footer1() {
  useEffect(() => {
    ...
    const toggleOpen = (event: any) => {
      ...
      if (!parent) return;
      const content = parent.querySelector(".footer-v2-col-content") as HTMLElement;
      if (!content) return;
      ...
      <div className="footer-v2-container">
        <div className="footer-v2-grid">
          ...
          <div className="footer-v2-col">
            ...
            <div className="footer-v2-col-content">
              <ul className="footer-v2-links">
                ...
                <li><Link href="/faq">Cómo funciona</Link></li>
          ...
          <div className="footer-v2-col">
            ...
            <div className="footer-v2-col-content">
              <ul className="footer-v2-links">
                <li><Link href="/faq">Centro de ayuda</Link></li>
                <li><Link href="/contact">Contacto</Link></li>
                <li><Link href="/privacy">Confianza y seguridad</Link></li>
                <li><Link href="/privacy">Envíos y pagos</Link></li>
                <li><Link href="/privacy">Reembolsos</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="footer-v2-col">
            ...
            <div className="footer-v2-col-content">
              <ul className="footer-v2-links">
                <li><Link href="#">Comunidad espublicar</Link></li>
                <li><Link href="#">Programa Pro</Link></li>
                <li><Link href="#">Invita a un amigo</Link></li>
        ...
        <div className="footer-v2-bottom">
          <div className="footer-v2-bottom-left">
            <span>© 2025 espublicar · Todos los derechos reservados</span>
